...
import { SillyDatatable2OptionsComponent } from './silly-datatable2-options.component';
import { StoreService } from './../../services/store.service';
import { Column } from './../../models/column.model';


describe('SillyDatatable2OptionsComponent', () => {
  let component: SillyDatatable2OptionsComponent;
  let fixture: ComponentFixture<SillyDatatable2OptionsComponent>;
  let columns = [];
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [SillyDatatable2OptionsComponent],
      providers: [
        StoreService,
      ],
    })
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(SillyDatatable2OptionsComponent);
