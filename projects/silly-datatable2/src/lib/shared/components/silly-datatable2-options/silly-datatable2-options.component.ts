...
@Component({
  selector: 'ngx-silly-datatable2-options',
  templateUrl: './silly-datatable2-options.component.html',
  styles: [],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SillyDatatable2OptionsComponent implements OnDestroy {
