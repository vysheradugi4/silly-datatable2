...
@Component({
  selector: 'ngx-silly-datatable2-filter',
  templateUrl: './silly-datatable2-filter.component.html',
  styles: [],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SillyDatatable2FilterComponent implements OnDestroy {
   ...
   */
  public trackByFn(_: any, item: FilterFormField): string | any[] {
  ...
  private initFormFieldsLogic(): void {
    ...
    this.filtersFormArray = this.filterForm.controls['filters'] as FormArray;
