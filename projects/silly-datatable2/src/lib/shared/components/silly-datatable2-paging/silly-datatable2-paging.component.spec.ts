...
import { SillyDatatable2PagingComponent } from './silly-datatable2-paging.component';
import { PipesModule } from './../../pipes/pipes.module';
import { TableParams } from './../../models/table-params.model';
import { Pagination } from './../../../shared/models/pagination.model';


describe('SillyDatatable2PagingComponent', () => {
  let component: SillyDatatable2PagingComponent;
  let fixture: ComponentFixture<SillyDatatable2PagingComponent>;
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [SillyDatatable2PagingComponent],
    })
      .compileComponents();
  }));

  beforeEach(() => {
    fixture = TestBed.createComponent(SillyDatatable2PagingComponent);
