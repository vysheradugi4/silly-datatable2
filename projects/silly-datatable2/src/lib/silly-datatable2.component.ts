...
@Component({
  ...
  templateUrl: './silly-datatable2.component.html',
  styles: [],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SillyDatatable2Component implements OnInit, OnDestroy {
   ...
   */
  @Input() public set searchComponent(component: SillyDatatable2SearchComponent) {
    if (!component) {
      return;
    }
   ...
   */
  @Input() public set filterComponent(component: SillyDatatable2FilterComponent) {
    if (!component) {
      return;
    }
   ...
   */
  @Input() public set pagingComponent(component: SillyDatatable2PagingComponent) {
    if (!component) {
      return;
    }
   ...
   */
  @Input() public set optionsComponent(component: SillyDatatable2OptionsComponent) {
    if (!component) {
      return;
    }
  ...
  public batchSelectFormGroup: FormGroup = new FormGroup({ checkboxes: new FormArray([]) });
  public checkboxes: FormArray = this.batchSelectFormGroup.get('checkboxes') as FormArray;
  ...
  private _tableParams: TableParams | null = null;
  private _tableUid: string | null = null;
  private _optionsComponent: SillyDatatable2OptionsComponent | null = null;
  private _pagingComponent: SillyDatatable2PagingComponent | null = null;
  private _filterComponent: SillyDatatable2FilterComponent | null = null;
  private _searchComponent: SillyDatatable2SearchComponent | null = null;
   ...
   * @param event Data
   */
  public onComponentCellEvent(event: any): void {
    this.componentCellEvent.next(event);
  }


  public trackByFn(_: any, item: any) {
    return item.show;
  }
